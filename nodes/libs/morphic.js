...
/*
    ...
    * included only for demo purposes
    ...
    are tree BaseNodes and may contain any number of submorphs ("children").
...
function BaseNode(parent, childrenArray) {
...
BaseNode.prototype.addChild = function (aBaseNode) {
    this.children.push(aBaseNode);
    aBaseNode.parent = this;
};

BaseNode.prototype.addChildFirst = function (aBaseNode) {
    this.children.splice(0, null, aBaseNode);
    aBaseNode.parent = this;
};

BaseNode.prototype.removeChild = function (aBaseNode) {
...
BaseNode.prototype.depth = function () {
    if (this.parent === null) {
        return 0;
    }
...
BaseNode.prototype.allChildren = function () {
    // includes myself
    var result = [this];
...
BaseNode.prototype.forAllChildren = function (aFunction) {
...
BaseNode.prototype.anyChild = function (aPredicate) {
    // includes myself
    var i;
...
BaseNode.prototype.allLeafs = function () {
    var result = [];
...
BaseNode.prototype.allParents = function () {
    // includes myself
    var result = [this];
    if (this.parent !== null) {
...
BaseNode.prototype.siblings = function () {
    if (this.parent === null) {
        return [];
    }
...
BaseNode.prototype.parentThatIsA = function () {
    // including myself
...
BaseNode.prototype.parentThatIsAnyOf = function (constructors) {
    // deprecated, use parentThatIsA instead
    return this.parentThatIsA.apply(this, constructors);
};

BaseNode.prototype.childThatIsA = function () {
    // including myself
    // Note: you can pass in multiple constructors to test for
    var i, hit;
    for (i = 0; i < arguments.length; i += 1) {
...
Morph.prototype = new BaseNode();
Morph.prototype.constructor = Morph;
Morph.uber = BaseNode.prototype;
...
BoxMorph.prototype.outlinePath = function (ctx, corner, inset) {
    ...
    // worst bug fix ever award goes to my asscheeks:
    if (radius < 0) {
        radius = 0.01;
    }
