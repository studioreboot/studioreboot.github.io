...
Morph.prototype.drawOn = function (ctx, rect) {
    ...
    if (typeof this.world === "function") {
        if (this.world() instanceof WorldMorph) {
            this.world().showDrawnRect(ctx, clipped);
        }
    }
};
...
FrameMorph.prototype.fullDrawOn = function (ctx, aRect) {
    ...
    this.children.filter((v => v.bounds.intersects(clipped) || v.children.filter(j => j.bounds.intersects(clipped)).length > 0)).forEach((child) => {
...
WorldMorph.prototype.init = function (aCanvas, fillPage) {
    ...
    this.animations = [];
    this.hands = [];
    this.hands.push(new HandMorph(this));
...
Object.defineProperty(WorldMorph.prototype, "hand", {
    /** @returns {HandMorph} */
    get: function () {
...
WorldMorph.prototype.fullDrawOn = function (aContext, aRect) {
    ...
    for (let i = 0; i < this.hands.length; i++) {
        ...
        hand.fullDrawOn(aContext, aRect);
    }
};
...
WorldMorph.prototype.showBrokenRect = function (ctx, rect) {
    ctx.save();
    ctx.strokeStyle = "red";
...
WorldMorph.prototype.showDrawnRect = function (ctx, rect) {
    ctx.save();
...
WorldMorph.prototype.initEventListeners = function () {
    ...
    canvas.addEventListener(
        "mousemove",
        event => {
            // if (this.hand) console.log(this.hand);
